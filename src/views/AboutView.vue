<template>
  <div class="container mt-4">
    <div class="filter-buttons">
      ...
      <div class="filters">
        <button class="filter" @click="openDatePicker">Seleziona Data</button>
...
.scrolling-container {
  white-space: nowrap;
  overflow-x: auto;
  -ms-overflow-style: -ms-autohiding-scrollbar; /* Aggiungi questo se stai lavorando con Internet Explorer */
  flex-wrap: nowrap; /* Assicurati che i pulsanti rimangano su una singola riga */
  display: flex; /* Mostra i pulsanti come una serie orizzontale */
}
.filter-buttons {
  display: flex;
}
